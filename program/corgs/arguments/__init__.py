...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.rand_pcd = False
        self.n_sparse = -1
        # Number of generated cameras used by CoR-GS/FSGS pseudo-view losses.
        # Keep this bounded because each PseudoCamera owns CUDA transforms.
        self.pseudo_views = 256
