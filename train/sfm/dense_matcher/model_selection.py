...
import torch
from admin.model_constructor import NetConstructor
from admin.local import EnvironmentSettings
from admin.stats import StatValue, AverageMeter
...
def load_network(net, checkpoint_path=None, **kwargs):
    ...
    # contains only these bundled reference classes, so allowlist them explicitly.
    with torch.serialization.safe_globals(
            [NetConstructor, EnvironmentSettings, StatValue, Settings, AverageMeter]):
