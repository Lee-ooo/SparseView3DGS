...
def _local_midas():
    """Load an official MiDaS checkpoint shipped under train/weights."""
    ...
    try:
        ...
        if midas is None:
            raise FileNotFoundError(
                "No valid local MiDaS weights found under train/weights"
            )
        ...
        warnings.warn(
            ...
            "or place a MiDaS checkpoint under train/weights.",
            RuntimeWarning,
        )
        midas = None
    return midas
